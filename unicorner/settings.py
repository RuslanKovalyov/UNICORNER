...
print('DEBUG______________________', DEBUG)
...
MIDDLEWARE = [
    ...
    'warehouse.auth.WarehouseAuthenticationMiddleware',
]

ROOT_URLCONF = 'unicorner.urls'
...
WSGI_APPLICATION = 'unicorner.wsgi.application'
